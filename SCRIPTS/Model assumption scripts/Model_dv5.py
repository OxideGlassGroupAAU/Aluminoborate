...
def data_load(file_name, col_nr):
    data_col = []
...
Al_data = data_load(fil, 1)
R_data = data_load(fil, 2)
Q3_data = data_load(fil, 3)
Q4_data = data_load(fil, 4)
Q2_data = data_load(fil, 5)
Q1_data = data_load(fil, 6)
Q0_data = data_load(fil, 7)
Al5_data = data_load(fil, 8)
Al4_data = data_load(fil, 9)
